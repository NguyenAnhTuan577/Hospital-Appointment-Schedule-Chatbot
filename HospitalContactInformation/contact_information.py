...
xxx = {
    ...
    "currentIntent": {
        "name": "HospitalContactInformation",
        "slots": {
...
def contact_information(intent_request):
    """
...
def dispatch(intent_request):
    ...
    if intent_name == 'HospitalContactInformation':
        return contact_information(intent_request)
